...
namespace Worksofallen\MailScheduler\Models;

use Illuminate\Contracts\Mail\Mailable;
use Illuminate\Contracts\Queue\ShouldBeEncrypted;
use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\MorphTo;
use Worksofallen\MailScheduler\Casts\SerializedMailable;
use Worksofallen\MailScheduler\Casts\SerializedObject;
 ...
 * @property \Worksofallen\MailScheduler\Enums\EmailStatus $status
