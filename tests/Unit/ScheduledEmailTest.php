...
use Worksofallen\MailScheduler\Models\ScheduledEmail as ScheduledEmailModel;
...
use Worksofallen\MailScheduler\Tests\Support\TestModel;
...
it('should throw an error when a scheduled email mailable is invalid', function () {
    ...
    /** @var \Worksofallen\MailScheduler\Models\ScheduledEmail $scheduledEmail */
