...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/worksofallen/laravel-mail-scheduler.svg)](https://packagist.org/packages/worksofallen/laravel-mail-scheduler)
[![Downloads](https://img.shields.io/packagist/dt/worksofallen/laravel-mail-scheduler.svg)](https://packagist.org/packages/worksofallen/laravel-mail-scheduler)
[![Run tests](https://github.com/worksofallen/laravel-mail-scheduler/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/worksofallen/laravel-mail-scheduler/actions/workflows/tests.yml)
</div>
...
use Worksofallen\MailScheduler\Support\Facades\ScheduledEmail;
...
| `retention_days`    | How many days to retain sent emails before they are eligible for deletion            | `int`    | `0`                |
| `retention_cron`    | The CRON expression used to run the retention cleanup command                        | `string` | `'59 23 * * *'`    |
| `delete_chunk_size` | Number of email records to delete per batch during cleanup                           | `int`    | `500`              |
